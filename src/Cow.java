...
public class Cow {
	...
	// draw will render the cow on the Graphics object
	public void draw(Graphics g, int cowX, int cowY)
	{
		...
		g2.setColor(Color.pink);
		// Meow text appears below cow head, +10 places below 
		// so it doesn't overlap the drawing
		g2.drawString("Meeeeeeuuuuuhhhh", cowX, cowY+HEAD_DIMENSION+10);	
	}
}
